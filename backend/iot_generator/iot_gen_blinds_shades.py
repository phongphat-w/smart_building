...
con_iot_device_id = "69b29098-c768-423e-ac2e-cc443e18f8a9" #Automated blinds or shades
        ...
        if auto_mode == 1:
            ...
            if iot_device_id == con_iot_device_id:
                ...
                light_level = {
                    ...
                    "sensor_value": round(random.uniform(0, 10000), 2), #Lux
                ...
                temperature = {
                    ...
                    "sensor_value": round(random.uniform(15, 30), 2),
                    "created_at": str(datetime.now()),
                    "auto_mode": 1,
                    "synced_flag": 0                    
                }
                ...
                lis_data.append(light_level)
                lis_data.append(temperature)
            ...
            if iot_device_id == con_iot_device_id:
                ...
                light_level_json = data.get("sensors", {}).get("light_level", None)  # Default to None if the key doesn't exist
                light_level = {
                    "data_id": str(uuid.uuid4()),
                    "device_id": iot_device_id,
                    "measured_at": str(datetime.now()),
                    "sensor_type": "light_level",
                    "sensor_value": round(light_level_json, 2),
                    "created_at": str(datetime.now()),
                    "auto_mode": 0,
                    "synced_flag": 0 
                }

                temperature_json = data.get("sensors", {}).get("temperature", None)  # Default to None if the key doesn't exist
                temperature = {
                    "data_id": str(uuid.uuid4()),
                    "device_id": iot_device_id,
                    "measured_at": str(datetime.now()),
                    "sensor_type": "temperature",
                    "sensor_value": round(temperature_json, 2),
                    "created_at": str(datetime.now()),
                    "auto_mode": 0,
                    "synced_flag": 0 
                }
