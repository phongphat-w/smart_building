...
con_iot_device_id = "080d460f-e54c-4262-a4ac-a3d42c40cbd5" #Demand-Controlled Ventilation (DCV)
        ...
        if auto_mode == 1:
            ...
            if iot_device_id == con_iot_device_id: #Smart thermostats
                ...
                co2 = {
                    ...
                    "sensor_type": "co2",
                    "sensor_value": round(random.uniform(400, 1000), 2),
                ...
                humidity = {
                    ...
                    "sensor_value": round(random.uniform(30, 80), 2),
                    "created_at": str(datetime.now()),
                    "auto_mode": 1,
                    "synced_flag": 0                    
                }
            ...
            if iot_device_id == con_iot_device_id: #Smart thermostats
                ...
                co2_json = data.get("sensors", {}).get("co2", None)  # Default to None if the key doesn't exist
                co2 = {
                    "data_id": str(uuid.uuid4()),
                    "device_id": iot_device_id,
                    "measured_at": str(datetime.now()),
                    "sensor_type": "co2",
                    "sensor_value": round(co2_json, 2),
                    "created_at": str(datetime.now()),
                    "auto_mode": 0,
                    "synced_flag": 0 
                }
                
                humidity_json = data.get("sensors", {}).get("humidity", None)  # Default to None if the key doesn't exist
                humidity = {
                    "data_id": str(uuid.uuid4()),
                    "device_id": iot_device_id,
                    "measured_at": str(datetime.now()),
                    "sensor_type": "humidity",
                    "sensor_value": round(humidity_json, 2),
                    "created_at": str(datetime.now()),
                    "auto_mode": 0,
                    "synced_flag": 0 
                }
